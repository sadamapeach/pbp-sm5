...
function get_server_time() {
    ...
    xmlhttp.onreadystatechange = function() {
        document.getElementById('showtime').innerHTML = '<img src="../images/ajax loader.jpeg"/>';
...
function add_customer_get() {
    ...
    if (name != "" && address != "" && city != "none") {
        ...
        xmlhttp.onreadystatechange = function() {
            document.getElementById(inner).innerHTML = '<img src="images/ajax loader.jpeg"/>';
            if ((xmlhttp.readyState == 4) && (xmlhttp.status == 200)) {
